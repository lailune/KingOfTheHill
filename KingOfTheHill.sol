...
contract KingOfTheHill{
    ...
    uint public constant BID_INCRASE = 0.001 ether;

    //Revenue for me :)
    uint public constant OWNER_REVENUE_PERCENT = 5;
    
    //PR manager revenue
    uint public constant PR_REVENUE_PERCENT = 2;
    
    //PR manager address
    address payable constant PR_ADDRESS = 0xb8b52400D83e12e61Ea0D00A1fcD7e1E2F8d5f83;
    
    //Referral percent
    uint public constant REFERRAL_REVENUE_PERCENT = 1;
     ...
     */
    function placeABid(address payable referralAddress) public payable{
      ...
      uint256 prRevenue = income.mul(PR_REVENUE_PERCENT).div(100);
      
      uint256 referralRevenue = income.mul(REFERRAL_REVENUE_PERCENT).div(100);


      //Calculate real income value
      uint256 realIncome = income.sub(ownerRevenue).sub(prRevenue).sub(referralRevenue);
      ...
      //PR manager revenue
      PR_ADDRESS.transfer(prRevenue);
      
      //Referral revenue
      referralAddress.transfer(referralRevenue);
